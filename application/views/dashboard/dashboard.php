                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    ...
                                    <div class="stat-digit"><i class="fa fa-money"></i> <?= "Rp " . number_format($Total_Invoice->grand_total_invoice) ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    ...
                                    <div class="stat-digit"><i class="fa fa-users"></i> <?= $Total_Siswa ?> </div>
                                </div>
                            </div>
                        </div>
                    </div>
