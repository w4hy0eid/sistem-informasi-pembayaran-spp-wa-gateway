...
<head>
    ...
    <title><?= JUDUL ?> - Edit Bendahara</title>
                    ...
                    <div class="col-xl-12 col-xxl-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Edit Bendahara</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="<?= base_url() ?>bendahara/save_edit" method="POST" autocomplete="off">
                                        <?php if ($this->session->flashdata('pesan') != null) { ?>
                                            <p class="text-center"><?= $this->session->flashdata('pesan'); ?></p>
                                        <?php } ?>
                                        <div class="form-row">
                                            <input type="hidden" name="id_user" value="<?= $bendahara->id_bendahara ?>" required>
                                            <div class="form-group col-md-6">
                                                <label>Username</label>
                                                <input type="text" class="form-control" name="username" value="<?= $bendahara->nama_bendahara ?>" placeholder="Username" readonly="true" required>
                                            </div>
                                            <div class="form-group col-md-6">
